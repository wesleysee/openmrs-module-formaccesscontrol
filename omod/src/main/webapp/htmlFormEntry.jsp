<%@ taglib prefix="formaccesscontrol" uri="/WEB-INF/view/module/formaccesscontrol/taglibs/formaccesscontrol.tld" %>
...
<c:if test="${command.context.mode == 'ENTER'}">
	<formaccesscontrol:require form="${command.form}" privilege="CREATE" otherwise="/login.htm" />
</c:if>
<c:if test="${command.context.mode == 'VIEW'}">
	<formaccesscontrol:require form="${command.form}" privilege="VIEW" otherwise="/login.htm" />
</c:if>
		...
		<c:if test="${command.context.mode == 'VIEW'}">
			<c:if test="${!inPopup}">
				<openmrs:hasPrivilege privilege="Edit Encounters,Edit Observations">
					<formaccesscontrol:hasPrivilege privilege="Edit" form="${command.form}">
					...
					</formaccesscontrol:hasPrivilege>
